...
<ul class="big_button_bar">
	...
	<li class="big_button" ><a href="<?php echo site_url('informes/cuadrante_diario');?>"><?php echo img( array('src'=>'images/list_by_date.png', 'border'=>'0', 'alt' => $this->lang->line('report_cuadrante_diario')));?><br><?php echo $this->lang->line('report_cuadrante_diario'); ?></a></li>
