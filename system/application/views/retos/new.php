    ...
    <table width="100%" border="0" cellspacing="10" class="nota">
      <tr>
        <td width="470" valign="top">
            ...
            <input type="text" name="limit_date" id="limit_date" value="<?php echo $default['limit_date']; ?>" size="10" />
            </label>
						<label><span>G&eacute;nero</span>
							<select name="gender" id="gender">
								...
								//pinto combo de niveles
									...
									{
										echo '<option value="'.$code.'">'.$genero.'</option>';
									}
								?>
							</select>
						</label>
            ...
            <input type="text" name="last_notify" id="last_notify" value="<?php echo $default['last_notify']; ?>" size="2"  alt="integer"/>
            </label>-->
            <input type="hidden" name="last_notify" id="last_notify" value="<?php echo $default['last_notify']; ?>" size="2"  alt="integer"/>
        ...
        <td width="476" >
            ...
            <input type="text" name="players" id="players" value="<?php echo $default['players']; ?>" size="5" alt="integer"/>
          	</label>
            <label><span>Coste/Jugador</span>
            <input type="text" name="price_by_player" id="price_by_player" value="<?php echo $default['price_by_player']; ?>" size="5" alt="dinero" />
            </label>
            ...
            <input type="checkbox" name="visible" id="visible" <?php echo $default['visible']; ?>/>
            </label>
