...
.Letra_Mediana {
  ...
  <form class="form_user" name="formReto" id="formReto" method="post">
  	...
  	<input name="returnUrl" id="action" type="hidden" value="<?php echo site_url('retos/view/'.$id_transaction); ?>"/>
...
?>
    ...
    <div class="separador">
		...
		<?php } else {?>
				<span class="Letra_Granate" style="font-size:12px;">No puede inscribirse a este reto</span>
