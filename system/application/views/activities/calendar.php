<script type="text/javascript">
    $(document).ready(function() {     
       var view="week";          
        ...
        var DATA_FEED_URL = "<?php echo site_url("activities/datafeed"); ?>";
        var op = {
            view: view,
            theme:3,
            showday: new Date(),
        ...
        function Edit(data)
        {
           /*var eurl="<?php echo site_url("activities/edit"); ?>/{0}";   */
...
<div id="general">
  <div id="calhead" style="padding-left:1px;padding-right:1px;">          
    <div class="cHead"><div class="ftitle">Visor de actividades</div>
    <div id="loadingpannel" class="ptogtitle loadicon" style="display: none;">Cargando datos...</div>
     <div id="errorpannel" class="ptogtitle loaderror" style="display: none;">Lo sentimos. No hemos podido cargar los datos. Pruebe de nuevo m&aacute;s tarde.</div>
    </div>          
