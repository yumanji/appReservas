...
<body>
<div style="font-size:18px; text-align:center"><a href="<?php echo site_url("/flexigrid/index");?>">Demo</a> | <a href="<?php echo site_url("/flexigrid/example");?>">Documentation</a> | <a href="http://flexigrid.eyeviewdesign.com/<?php echo $download_file;?>">Download</a></div>
<h1>Files Needed:</h1>
- <a href="http://flexigrid.eyeviewdesign.com/<?php echo $download_file;?>">Click here to download CI Flexigrid with samples</a>
<h1>Introduction:</h1>
This is an example on how to setup a grid like in the <a href="<?php echo site_url("/flexigrid/index");?>">demonstration</a>. I assume that you already have some bases on CI before reading this, if you dont, read their excellent documentation <a href="http://codeigniter.com/user_guide/">here</a>. <br/>I'm sorry for any misspellings. <br/>I strongly advise to <a href="http://flexigrid.eyeviewdesign.com/<?php echo $download_file;?>">download the example</a> and look at the code while reading this, it will be much easier. 
<h1>Setup:</h1>
...
<code>
		...
		{<br/>
			...
			$row->iso3,<br/>
			$row->numcode,<br/>
			'&lt;a href=\'#\'&gt;&lt;img border=\'0\' src=\''.$this->config->item('base_url').'images/close.png\'&gt;&lt;/a&gt; '<br/>
			);<br/>
		}<br/><br/>
		//Print please<br/>
...
&lt;html&gt;<br />
  ...
  &lt;script type=&quot;text/javascript&quot; src=&quot;&lt;?=$this-&gt;config-&gt;item('base_url');?&gt;js/jquery.pack.js&quot;&gt;&lt;/script&gt;<br />
  &lt;script type=&quot;text/javascript&quot; src=&quot;&lt;?=$this-&gt;config-&gt;item('base_url');?&gt;js/flexigrid.pack.js&quot;&gt;&lt;/script&gt;<br />
  &lt;/head&gt;<br />
  &lt;body&gt;
<br /><br />
  &lt;?=$js_grid;?&gt;<br /><br />
