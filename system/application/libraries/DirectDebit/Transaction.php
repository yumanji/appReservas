...
class Sepa_DirectDebit_Transaction {
    ...
    public function setAmount($amount) {
        $this->_amount = n19Sepa_Base::floatToCurrency($amount);
        return $this;
    }
    ...
    public function setDebtorName($debtorName) {
        $this->_debtorName = n19Sepa_Base::alphanumeric($debtorName, 70);
        return $this;
    }
    ...
    public function setTransactionDescription($transactionDescription) {
        $this->_transactionDescription = n19Sepa_Base::alphanumeric($transactionDescription, 140);
        return $this;
    }
