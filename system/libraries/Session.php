    ...
    function sess_read()
    {
        ...
        foreach( array('session_id', 'ip_address', 'user_agent', 'last_activity') as $key )
        {
            if( !isset($_SESSION[$key]) ) {
            	log_message('debug', "Error de sesion 1");
                $this->sess_destroy();
                return FALSE;
            }
        ...
        {
            	log_message('debug', "Error de sesion 2");
            $this->sess_destroy();
            return FALSE;
        }
        ...
        {
            	log_message('debug', "Error de sesion 3");
            $this->sess_destroy();
            return FALSE;
        }
        ...
        {
            	log_message('debug', "Error de sesion 4");
            $this->sess_destroy();
            return FALSE;
        }
        ...
        if ($query->num_rows() == 0)
        {
            	log_message('debug', "Error de sesion 5");
            $this->sess_destroy();
            return FALSE;
        }
