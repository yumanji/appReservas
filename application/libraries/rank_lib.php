...
//print('<pre>');print_r($equipos);			
	...
	public function getTeamsCalculated($id, $round = '0', $group = '', $no_order = FALSE)
	{
		...
		if($no_order) { 
			...
			$equipos = $this->CI->app_common->ordenar_array($equipos, 'group', SORT_ASC, 'puntos', SORT_DESC, 'PG', SORT_DESC, 'SD', SORT_DESC, 'JD', SORT_DESC, 'SG', SORT_DESC, 'JG', SORT_DESC);
...
//exit();
			...
			if(!$no_order) $equipos = $this->CI->app_common->ordenar_array($equipos, 'group', SORT_ASC, 'puntos', SORT_DESC, 'desempate', SORT_DESC, 'PG', SORT_DESC, 'SD', SORT_DESC, 'JD', SORT_DESC, 'SG', SORT_DESC, 'JG', SORT_DESC);
