<?php
	...
	echo $this->lang->line('mail_booking_intro_change').' <b>'. $info_antigua['booking_code'].'</b>'.$this->lang->line('mail_booking_intro2_change').' <b>'.$info['booking_code'].'</b>.<br>&nbsp;<br>'."\r\n";
	...
	echo $this->lang->line('mail_booking_greetings').'<br>&nbsp;<br>'."\r\n";
