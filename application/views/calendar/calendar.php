<script type="text/javascript">
    $(document).ready(function() {     
       var view="month";          
        ...
        var DATA_FEED_URL = "<?php echo site_url("calendar/datafeed"); ?>";
        var op = {
            view: view,
            theme:3,
            showday: new Date(),
        ...
        function Edit(data)
        {
           /*var eurl="<?php echo site_url("calendar/edit"); ?>/{0}";   */
...
<div id="general">
  <div id="calhead" style="padding-left:1px;padding-right:1px;">          
    <div class="cHead"><div class="ftitle">Calendario personal</div>
