...
<br><br>	
    ...
    <tr>
        <td colspan="4" class="Carteles" align="center">Recuperaci&oacute;n de clase</td>
    </tr>
    <tr>
        <td>&nbsp;</td>											
        <td class="Cabecera_Tablas">Clase recuperada: </td>
        <td class="Letra_Mediana"><input type="checkbox" name="recovered" value="1" <?php if(stristr($info['recovered'], 's')) echo 'checked';?>></td>
        <td>&nbsp;</td>
    </tr>
    <tr>
        <td>&nbsp;</td>											
        <td class="Cabecera_Tablas">Fecha: </td>
        <td class="Letra_Mediana"><input type="text" name="recovered_date" id="recovered_date" value="<?php if($info['recovered_date']!="") echo date($this->config->item('reserve_date_filter_format'), strtotime($info['recovered_date'])); ?>" size="10" /></td>
        <td>&nbsp;</td>
    </tr>
    <tr>
        <td>&nbsp;</td>											
        <td class="Cabecera_Tablas">Observaciones* : </td>
        <td class="Letra_Mediana"><?php echo form_textarea(array('name' => 'recovered_obs', 'id' => 'recovered_obs', 'maxlength' => 255, 'value' => $info['recovered_obs'], 'rows' => '6', 'cols' => '50', 'class' => 'Letra_Mediana')); ?><br><span class="charsRemaining2">Quedan 255 caracteres.<br></td>
        <td>&nbsp;</td>
    </tr>
  <?php
	...
	$(function() {
		...
		.click(function() {
			...
			if($("#date_lesson").val() != '' && $("#observations").val() != '' && $("#id_instructor").val() != '') {
				$('#action').val('save');
				$("#formCurso").attr("action", "<?php echo site_url('lessons/recover_daily_report/'.$info['id']); ?>");
				$('#formCurso').submit();
