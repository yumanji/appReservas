...
function jqGrid_ondblClickRow() {
	...
	if(gsr){
		...
		location.href='<?php echo site_url('retos/detail'); ?>/'+gsr;
...
$(function() {
		...
		jQuery("#grid_name").jqGrid('navButtonAdd','#pager2',{caption:"", buttonicon:"ui-icon-plusthick", title:'Crear reto',
			onClickButton:function(){

					location.href='<?php echo site_url('reservas/index/'.time()); ?>';
						
			} 
		});		
		
		
		jQuery("#grid_name").jqGrid('navButtonAdd','#pager2',{caption:"", buttonicon:"ui-icon-mail-closed", title:'Notificar reto creado',
			onClickButton:function(){
				var gsr = jQuery("#grid_name").jqGrid('getGridParam','selrow');
				if(gsr){
					//alert(gsr);
					...
					document.getElementById('hora_fin_view').value = horaFin;
					*/
					location.href='<?php echo site_url('retos/notify'); ?>/'+gsr;
		...
		jQuery("#grid_name").jqGrid('navButtonAdd','#pager2',{caption:"", buttonicon:"ui-icon-closethick", title:'Cancelar reto',
			onClickButton:function(){
				var gsr = jQuery("#grid_name").jqGrid('getGridParam','selrow');
				if(gsr){
					//alert(gsr);
					...
					document.getElementById('hora_fin_view').value = horaFin;
					*/
					location.href='<?php echo site_url('retos/cancel'); ?>/'+gsr;
