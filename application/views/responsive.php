...
<?php 
	echo link_tag('assets/global/plugins/bootstrap-daterangepicker/daterangepicker-bs3.css');
	echo link_tag('assets/global/plugins/fullcalendar/fullcalendar.min.css');
	echo link_tag('assets/global/plugins/jqvmap/jqvmap/jqvmap.css');
?>
<!-- END PAGE LEVEL PLUGIN STYLES -->
<!-- BEGIN PAGE STYLES -->
<?php 
	echo link_tag('assets/admin/pages/css/tasks.css');
?>
<!-- END PAGE STYLES -->
<!-- BEGIN THEME STYLES -->
<?php 
	echo link_tag(array('href' => 'assets/global/css/components.css', 'rel' => 'stylesheet', 'type' => 'text/css', 'id' => 'style_components'));
	echo link_tag('assets/global/css/plugins.css');
	echo link_tag('assets/admin/layout/css/layout.css');
	echo link_tag(array('href' => 'assets/admin/layout/css/themes/darkblue.css', 'rel' => 'stylesheet', 'type' => 'text/css', 'id' => 'style_color'));
	echo link_tag('assets/admin/layout/css/custom.css');
?>
<!-- END THEME STYLES -->
<?php 
...
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner">
		...
		<div class="page-logo">
			...
			<?php echo img(array('src' => 'assets/admin/layout/img/logo_cliente.png', 'alt' => 'logo', 'class' => 'logo-default')); ?>
						...
						<li>
							<ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
								<li>
									...
									<span class="photo">
									<?php echo img(array('src' => 'assets/admin/layout3/img/avatar2.jpg', 'alt' => '', 'class' => 'img-circle')); ?>
								...
								<li>
									<a href="inbox.html?a=view">
									<span class="photo">
									<?php echo img(array('src' => 'assets/admin/layout3/img/avatar1.jpg', 'alt' => '', 'class' => 'img-circle')); ?>
