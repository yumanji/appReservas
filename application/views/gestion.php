...
?>
    ...
    <div id="container">
      ...
      <div id="main">
    	...
    	?>	
			...
			<div id="dialog-message" class="ui-state-highlight ui-corner-all" style="margin-top: 10px; margin-left: 200px; margin-right: 200px; padding: 0 .7em;">
    ...
    <?php
    	...
    	?>	
			...
			<div id="dialog-message" class="ui-state-error ui-corner-all" style="margin-top: 10px; margin-left: 200px; margin-right: 200px; padding: 0 .7em;">
