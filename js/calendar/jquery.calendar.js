/**
  ...
  */
; (function($) {
    var __WDAY = new Array(i18n.xgcalendar.dateformat.dom, i18n.xgcalendar.dateformat.mon, i18n.xgcalendar.dateformat.tue, i18n.xgcalendar.dateformat.wed, i18n.xgcalendar.dateformat.thu, i18n.xgcalendar.dateformat.fri, i18n.xgcalendar.dateformat.sat);
    ...
    if (!dateFormat || typeof (dateFormat) != "function") {
        var dateFormat = function(format) {
            var o = {
                ...
                "X": __MonthName[this.getMonth()] //non-standard
            };
            //alert(this.getDay());
            //alert(o['W']);
            if (/(y+)/.test(format)) {
    ...
    $.fn.bcalendar = function(option) {
        ...
        function BuildDaysAndWeekView(startday, l, events, config) {
            ...
            if (l == 1) {
                ...
                for (var i = w, j = 0; j < l; i = i + 1, j++) {
                    ...
                    //alert(dateFormat(ndate, "dddd, mmmm dS, yyyy, h:MM:ss TT"));
                }
                option.vstart = days[0].date;
        ...
        function getTitle(event) {	
        	var str='';	
        		/*
        		// Listado de propiedades de objeto
        		for(prop in event)
						{
            ...
            ret.push("Duracion", (event[11]!="")?" de "+event[11]:"", (event[12]!="")?" a "+event[12]:"", $.browser.mozilla?"":"\r\n", "Nivel",(event[16]!="")?": "+event[16]:" no definido", $.browser.mozilla?"":"\r\n", "Profesor", (event[13]!="")?": "+event[13]:" no definido", $.browser.mozilla?"":"\r\n", "Plazas", (event[18]!=0)?" libres: "+event[18]+" de "+event[17]:" agotadas", $.browser.mozilla?"":"\r\n", i18n.xgcalendar.location + ": ", locationshow,  (event[19]!=0)?($.browser.mozilla?"":"\r\n")+"Hay usuarios en lista de espera":"");
            if (attendsshow != "") {
                ...
                for (var h = 0; h < l; ) {
                    ...
                    if (e) { 
                        ...
                        if (!bs && j == (sc - 1) && z[h] < y[h]) {
                            el++;
                            $.extend(tempdata, { "axis": h, ch: "more", "abbr": dateFormat.call(cday[h], i18n.xgcalendar.dateformat.fulldayvalue), html: i18n.xgcalendar.others + (y[h] - z[h]) + i18n.xgcalendar.others2 + i18n.xgcalendar.item, click: "javascript:alert('more event');" });
        ...
        function populate() {
            ...
            if (option.url && option.url != "") {
               ...
               // alert(option.showday);
                //alert(i18n.xgcalendar.dateformat.fulldayvalue);
                var param = [
                { name: "showdate", value: dateFormat.call(option.showday, i18n.xgcalendar.dateformat.fulldayvalue) },
                { name: "viewtype", value: option.view },
				 { name: "timezone", value: zone }
                ];
                //alert(dateFormat.call(option.showday, i18n.xgcalendar.dateformat.fulldayvalue));
                if (option.extParam) {
            ...
            if (data != null) {
                if (option.quickDeleteUrl != "" && data[8] == 1 && option.readonly != true) {
                    var csbuddle = '<div id="bbit-cs-buddle" style="z-index: 180; width: 400px;visibility:hidden;" class="bubble"><table class="bubble-table" cellSpacing="0" cellPadding="0"><tbody><tr><td class="bubble-cell-side"><div id="tl1" class="bubble-corner"><div class="bubble-sprite bubble-tl"></div></div><td class="bubble-cell-main"><div class="bubble-top"></div><td class="bubble-cell-side"><div id="tr1" class="bubble-corner"><div class="bubble-sprite bubble-tr"></div></div>  <tr><td class="bubble-mid" colSpan="3"><div style="overflow: hidden" id="bubbleContent1"><div><div></div><div class="cb-root"><table class="cb-table" cellSpacing="0" cellPadding="0"><tbody><tr><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><div id="bbit-cs-what" title="'
                    	+ i18n.xgcalendar.click_to_detail + '" class="textbox-fill-div"></div></div></div></td></tr><tr><td class=cb-value><div id="bbit-cs-buddle-timeshow"></div></td></tr></tbody></table><div class="bbit-cs-split"><input id="bbit-cs-id" type="hidden" value=""/>[ <span id="bbit-cs-delete" class="lk">'
        ...
        function quickadd(start, end, isallday, pos) {
            ...
            if (buddle.length == 0) {
                ...
                temparr.push(i18n.xgcalendar.content, ':</th><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><input id="bbit-cal-what" class="textbox-fill-input"/></div></div>');
                temparr.push('</td></tr></tbody></table><input id="bbit-cal-start" type="hidden"/><input id="bbit-cal-end" type="hidden"/><input id="bbit-cal-allday" type="hidden"/><input id="bbit-cal-quickAddBTN" value="');
                ...
                temparr.push(i18n.xgcalendar.create_event, '" type="button"/>&nbsp; ');
