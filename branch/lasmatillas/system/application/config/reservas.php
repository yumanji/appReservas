...
$config['app_name']	= 'Las Matillas - Reserva Deportiva';
$config['app_provider']	= 'Reserva Deportiva';
$config['app_title']	= 'Las Matillas - ReservaDeportiva.com - La forma de reservar donde jugar, sin moverte de casa';
$config['club_name']	= 'Las Matillas';
$config['club_url']	= 'http://lasmatillas.reservadeportiva.com';
$config['club_address']	= 'Dirección desconocida';
$config['club_population']	= 'Arroyomolinos - Madrid';
$config['email_from_desc']	= $config['club_name'].' desde '.$config['app_provider'];
$config['email_from']	= 'comunicaciones@lasmatillas.com';
$config['email_replyto']	= 'comunicaciones@lasmatillas.com';
$config['email_reply_to']   = TRUE;
$config['email_reply_to_address']   = 'comunicaciones@lasmatillas.com';
$config['club_map']   = 'mapa.jpg';
$config['club_normativa']   = '';
$config['club_weather']   = '<!-- www.TuTiempo.net - Ancho:293px - Alto:107px -->
<div id="TT_vick1k1kkdfjdQsAKfuDjzDjz6uA1Ah2Lt1dkcyoqEz"><h2><a href="http://www.tutiempo.net">Previsión el tiempo</a></h2><a href="http://www.tutiempo.net/Tiempo-Arroyomolinos-E28075.html">El tiempo en Arroyomolinos</a></div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_vick1k1kkdfjdQsAKfuDjzDjz6uA1Ah2Lt1dkcyoqEz"></script>';
...
$config['max_search_days']	= array(9 => 1, 8 => 1, 7 => 3, 6 => 7, 5 => 7, 4 => 7, 3 => 365, 2 => 365, 1 => 365);
$config['booking_delay_seconds']	= array(9 => 0, 8 => 0, 7 => 0, 6 => 0, 5 => 0, 4 => 0, 3 => 600, 2 => 600, 1 => 600);	// segundos de retraso con los que se puede reservar una hora ya pasada
...
$config['booking_record_players']	= TRUE;
$config['booking_record_players_number']	= 4;
$config['booking_record_players_range']	= array(1);
...
$config['cancelled_reserve_refund']	= array(9 => FALSE, 8 => FALSE, 7 => FALSE, 6 => FALSE, 5 => FALSE, 4 => FALSE, 3 => FALSE, 1 => FALSE); //Si es true se devuelve el dinero de la reserva a la cuenta prepago, si es false no se devuelve dinero
...
$config['reserve_minimum_intervals']	= array(9 => 1, 8 => 1, 7 => 1, 6 => 1, 5 => 1, 4 => 1, 3 => 1, 2 => 1, 1 => 1); // Numero de segmentos de reserva mínimos que el sistema permite reservar (al hacer click en un segmento, se seleccionan automaticamente  las adjuntas correspondientes, empezando desde el principio del dia)
...
$config['reserve_admin_notification_mail']	= 'info@reservadeportiva.com';
