...
public function get_data_to_export($params = "" , $page = "all")
{
    ...
    function save_user($array_user)
    {
		...
		if(isset($array_user['bank']) && $array_user['bank']!='') $data_meta['bank'] = $array_user['bank'];
		if(isset($array_user['bank_office']) && $array_user['bank_office']!='') $data_meta['bank_office'] = $array_user['bank_office'];
		if(isset($array_user['bank_dc']) && $array_user['bank_dc']!='') $data_meta['bank_dc'] = $array_user['bank_dc'];
		if(isset($array_user['bank_account']) && $array_user['bank_account']!='') $data_meta['bank_account'] = $array_user['bank_account'];
