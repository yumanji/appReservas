...
##############################################################################
    ...
    function getSportsArray()
    {
        ...
        //return $query->result();
        $result=array(""=>"Selecciona deporte");
...
//echo "B";    	
	...
	//echo "C";    	
			...
			//if($debug) exit('--------------------tarifa: '.$id_price);
				if($debug) print('--------------------tarifa: '.$id_price);
