...
##############################################################################
    ...
    function getPaymentMethodsByUser($user_level) {
    	...
    	elseif($user_level >= 3 && $user_level < 5 ) $pagos_adaptado = $this->CI->config->item('payment_operator_available');
    	elseif($user_level >= 5 && $user_level < 6 ) $pagos_adaptado = $this->CI->config->item('payment_profesor_available');
