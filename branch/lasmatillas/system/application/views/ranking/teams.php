     ...
     <tr>
        ...
        <td colspan = "2" valign="top" <?php if($i%2 == 0) echo 'align="left"'; else echo 'align="left"'; ?> >
        	<?php
        		...
        		echo '<tr class="CabeceraEquipoGrupo"><td>Equipo</td><td>Usuario titular</td><td width="20px">PJ</td><td width="20px">PG</td><td width="20px">PP</td><td width="20px">Ptos</td>';
        		$nivel = 'admin';
        		if($nivel == 'admin' && $permisos) echo '<td width="35px" nowrap align="right">Acciones</td>';
        		echo '</tr>'."\r\n";
