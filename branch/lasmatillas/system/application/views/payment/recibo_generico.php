  <?php
  //print("<pre>");print_r($info);print_r($pago);
  ?>
  <tr>
    <td>Pagado:</td>
  ...
  <tr>
    <td height="20" colspan="2"><div align="center"><strong>Concepto</strong></div></td>
    <!--<td><div align="center"><strong>Cantidad</strong></div></td>-->
    <td><div align="center"><strong>Importe</strong></div></td>
  </tr>

  <tr>
    <td height="15" colspan="2"><div align="center"><?php echo $pago->id_type_desc; ?></div></td>
  ...
  <tr>
    <td colspan="3">Forma de pago: <?php echo $pago->paymentway_desc; ?></td>
  </tr>
