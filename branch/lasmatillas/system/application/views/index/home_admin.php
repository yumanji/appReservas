...
<ul class="big_button_bar">
	...
	<?php if(isset($profile) && isset($profile->group) && $profile->group < 7) {  ?><li class="big_button" ><a href="<?php echo site_url('lessons/index');?>"><?php echo img( array('src'=>'images/profesor.png', 'border'=>'0', 'width' => '128', 'alt' => 'Clases y cursos', 'title' => 'Clases y cursos'));?><br>Clases</a></li><?php } ?>
	...
	<?php if(isset($profile) && isset($profile->group) && $profile->group < 7) {  ?><li class="big_button" ><a href="<?php echo site_url('ranking');?>"><?php echo img( array('src'=>'images/ranking.png', 'border'=>'0', 'width' => '128', 'alt' => 'Ranking', 'title' => 'Ranking'));?><br>Ranking</a></li><?php } ?>
