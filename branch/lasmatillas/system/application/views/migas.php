...
<?php
	...
	if(!$exception && $this->uri->segment(1)) {
		switch($this->uri->segment(1)) {
			...
			break;
			case "payment":
				echo '<li>&gt;&nbsp;&nbsp;<a href="'.site_url('gestion').'">Gestion</a></li><li>&gt;&nbsp;&nbsp;<a href="'.site_url($this->uri->segment(1)).'">Pagos</a></li>';
			break;
			case "facturacion":
				echo '<li>&gt;&nbsp;&nbsp;<a href="'.site_url('gestion').'">Gestion</a></li><li>&gt;&nbsp;&nbsp;<a href="'.site_url($this->uri->segment(1)).'">Facturacion</a></li>';
			break;
			case "reservas_gest":
			...
			break;
			case "ranking":
				echo '<li>&gt;&nbsp;&nbsp;<a href="'.site_url($this->uri->segment(1)).'">Ranking</a></li>';
			break;
