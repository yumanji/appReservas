  ...
  <form class="form_user" name="formUser" id="formUser" method="post">
    <table width="100%" border="0" cellspacing="10" class="nota">
      <tr>
        ...
        <td width="405" valign="top">
        	...
        	<label><span>Id</span>
              <input name="id" type="text" id="id" disabled value="<?php echo $code_user;?>" size="30" />
          </label>
	...
	<script type="text/javascript">
		...
		<div id="pagar_dialog" title="Pagar cuota">
			<p>De esta forma pagar&aacute; la cuota de socio hasta el pr&oacute;ximo <?php echo $next_payment_date; ?>. <br>Cuota a cobrar <input name="payable_quota_tmp" type="text" id="payable_quota_tmp" value="<?php echo number_format($quota,2).'&euro;'; ?>" size="7" alt="dinero"/></p>
		</div>
		<?php } ?>
