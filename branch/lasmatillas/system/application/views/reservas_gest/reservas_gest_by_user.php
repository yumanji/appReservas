...
?>
	...
	$(function() 
	{
		$('#cobrar_dialog').dialog({
			...
			buttons: {
				'Cobrar': function() {
					location.href='<?php echo site_url('reservas/confirm');?>/'+identificador;
				},
				'Cancelar': function() {
					$(this).dialog('close');
				}
...
<div id="luz_dialog" title="Activar Luz">
	<p>¿Est&aacute; seguro de querer activar la luz para la reserva?</p>
</div>
...
<div id="confirmar_dialog" title="Confirmar">
	<p>Est&aacute; seguro de querer modificar la reserva?</p>
</div>

<div id="cobrar_dialog" title="Cobrar Reserva">
	<p>Est&aacute; seguro de querer cobrar la reserva?</p>
</div>
