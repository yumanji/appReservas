...
<?php 
	...
	if(isset($normativa) && $normativa!='') echo anchor(base_url().'images/'.$normativa, img( array('src'=>'images/map.png', 'border'=>'0', 'alt' => 'Ver normativa', 'title' => 'Ver normativa', 'align'=>'right')), array('title' => 'Ver normativa' )).'<br><b>Ver normativa</b>';
	echo '</td>'."\r\n";
	echo '</td>'."\r\n";
	echo '</tr>'."\r\n";
	echo '</table>'; 
