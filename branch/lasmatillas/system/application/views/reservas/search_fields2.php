				...
				$(function() {
					...
					$("#buttonSubmit")
						.click( function() {
							...
							$("#search_intervals").html('		<div class="ui-widget">  <div class="ui-state-highlight ui-corner-all" > <p align="center">Loading....&nbsp;<?php echo img( array('src'=>'images/load.gif', "align"=>"absmiddle", "border"=>"0"));?></p>  </div> </div>');
							$("#accordion").accordion("activate" , 1);
			    		$("#search_filters").html('		<div class="ui-widget">  <div class="ui-state-highlight ui-corner-all" > <p><?php echo img( array('src'=>'images/warning_48.png', 'border'=>'0', 'alt' => 'Warning', 'align'=>'absmiddle')); ?>Si quiere reservar de nuevo, entre de nuevo en la secci&oacute;n de reservas o haga click <?php echo anchor('reservas', 'aqu&iacute;'); ?></p>  </div> </div>');
							$.ajax({
							  url: direccion,
							  success: function(data) {
							  	//alert(data);
							    $("#search_intervals").html(data);
							    //alert('Load was performed');
							    //$("#accordion").accordion("activate" , 1);
							  }
							});
							direccion =<?php echo "'".site_url('reservas/search2')."'";?>; // Reseteo variable
