...
<?php if($perfil->group > 5) { ?><li><a href="<?php echo site_url('reservas/index/'.time()); ?>" <?php if($selected_option['reservas']) echo 'class="actual"'; ?>>reservar</a></li><?php } ?>
<?php if($perfil->group <= 5) { ?><li><a href="<?php echo site_url('gestion'); ?>" <?php if($selected_option['gestion']) echo 'class="actual"'; ?>>gesti&oacute;n</a></li><?php } ?>
...
<?php if($perfil->group <= 5) { ?><li><a href="<?php echo site_url('notifications'); ?>" <?php if($selected_option['notifications']) echo 'class="actual"'; ?>>comunicaciones</a></li><?php } ?>
