...
$config['users_quota_group']	= array(9 => FALSE, 8 => FALSE, 7 => FALSE, 6 => TRUE, 5 => TRUE, 4 => FALSE, 3 => FALSE, 2 => FALSE, 1 => FALSE);
...
$config['users_search_extra_filters'] = array('meta.first_name', 'meta.last_name', 'users.id');
...
$config['users_register_legal_advice']	= FALSE;
