...
$config['app_title']	= 'Fitness Naranjo en ReservaDeportiva.com';
$config['club_name']	= 'Fitness Naranjo';
$config['club_url']	= 'http://www.fitnessnaranjo.es';
$config['club_address']	= 'Calle Oviedo, 13';
$config['club_population']	= 'Fuenlabrada (Madrid)';
