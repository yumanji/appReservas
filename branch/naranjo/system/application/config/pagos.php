...
|
*/
$config['payment_general_iva']	= 0.20;
...
$config['payment_admin_available']	= array('reserve' => TRUE, 'cash' => TRUE, 'prepaid' => TRUE, 'creditcard' => TRUE, 'paypal' => TRUE, 'bank' => TRUE, 'tpv' => FALSE );
$config['payment_operator_available']	= array('reserve' => TRUE, 'cash' => TRUE, 'prepaid' => FALSE, 'creditcard' => TRUE, 'paypal' => FALSE, 'bank' => FALSE, 'tpv' => FALSE );
$config['payment_profesor_available']	= array('reserve' => TRUE, 'cash' => FALSE, 'prepaid' => FALSE, 'creditcard' => FALSE, 'paypal' => FALSE, 'bank' => FALSE, 'tpv' => FALSE );
$config['payment_advanced_user_available']	= array('reserve' => TRUE, 'cash' => FALSE, 'prepaid' => FALSE, 'creditcard' => FALSE, 'paypal' => FALSE, 'bank' => FALSE, 'tpv' => TRUE );
$config['payment_user_available']	= array('reserve' => TRUE, 'cash' => FALSE, 'prepaid' => TRUE, 'creditcard' => FALSE, 'paypal' => FALSE, 'bank' => FALSE, 'tpv' => TRUE );
$config['payment_anonimo_available']	= array('reserve' => FALSE, 'cash' => FALSE, 'prepaid' => FALSE, 'creditcard' => FALSE, 'paypal' => FALSE, 'bank' => FALSE, 'tpv' => TRUE );
