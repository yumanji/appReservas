...
$config['app_provider']	= 'ReservaDeportiva';
$config['app_title']	= 'Carranque en ReservaDeportiva.com';
$config['club_name']	= 'Carranque';
$config['club_url']	= 'http://www.reservadeportiva.es';
$config['club_address']	= '';
...
$config['club_weather']   = '<div id="TT_LkkE1EEjNGsg9AuzzDDzzYlmTJJkejED1hbKy1J"><h2><a href="http://www.tutiempo.net/Tiempo-Espana.html">El Tiempo</a></h2><a href="http://www.tutiempo.net/Tiempo-Rivas-Vaciamadrid-E28595.html">El tiempo en Rivas-Vaciamadrid</a></div>
			<script type="text/javascript" src="http://www.tutiempo.net/TTapiV2/LkkE1EEjNGsg9AuzzDDzzYlmTJJkejED1hbKy1J"></script>';
...
$config['max_search_days']	= array(9 => 2, 8 => 2, 7 => 2, 6 => 2, 5 => 2, 4 => 2, 3 => 21, 2 => 21, 1 => 365);
$config['booking_delay_seconds']	= array(9 => 0, 8 => 0, 7 => 0, 6 => 0, 5 => 0, 4 => 0, 3 => 3600, 1 => 3600);	// segundos de retraso con los que se puede reservar una hora ya pasada
...
$config['booking_extra_lasmatillas']	= FALSE;
