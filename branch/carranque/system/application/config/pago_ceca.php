...
$config['tpv_library_sufix']	= 'ceca';


$config['tpv_nombre_comercio']	= 'CAFER FUENLABRADA GESTION Y SERVICIOS S.L.';
$config['tpv_codigo_comercio']	= '081429532';
$config['tpv_email_comercio']	= 'juanjo.nieto@gmail.com';
$config['tpv_palabra_secreta']	= '';	// real
$config['tpv_palabra_secreta']	= 'R6RQQI0J';	// Pruebas
