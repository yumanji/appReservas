...
$config['app_name']	= 'VillaPadel - Reserva Deportiva';
$config['app_provider']	= 'Reserva Deportiva';
$config['app_title']	= 'VillaPadel - ReservaDeportiva.com - La forma de reservar donde jugar, sin moverte de casa';
$config['club_name']	= 'VillaPadel';
$config['club_url']	= 'http://VillaPadel.reservadeportiva.com';
$config['club_address']	= 'Carretera de Aranjuez, 47. Villaconejos (28360) Madrid';
$config['club_population']	= 'Villaconejos - Madrid';
...
<div id="TT_vCJkkk111CAcdehA7AuDDDjzzWlA1A2lbt1tEsy5KkD53IGIG"><h2><a href="http://www.tutiempo.net">Previsión el tiempo</a></h2><a href="http://www.tutiempo.net/Tiempo-Villaconejos-E28825.html">El tiempo en Villaconejos</a></div>
<script type="text/javascript" src="http://www.tutiempo.net/widget/eltiempo_vCJkkk111CAcdehA7AuDDDjzzWlA1A2lbt1tEsy5KkD53IGIG"></script>';
